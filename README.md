...
<h1>六、未來擴充方向:</h1>
<h5>
    1.建立新功能擴充數據指標增加角色層次 （ex.記帳功能)。<br>
    2.將角色拆分為人物原型以及裝備配件，根據指標貼給人物穿著樣式。<br>
    3.加上JWT身份驗證並建立帳戶功能。<br>
    4.對後端資訊加上遮罩，初步建立資安防護。<br>
    5.長期規劃:允許不同帳戶間進行交流或訊息互動。<br>
    6.使用Docker將伺服器打包起來建立標準系統。<br>
</h5>
